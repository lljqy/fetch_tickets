...
from utils.common import TIME_FORMAT, time_print, engine
...
class Campany(JZSC):
    ...
    def run_province(self) -> None:
        dir_path = self._ROOT_PATH / '省份数据'
        dir_path.mkdir(exist_ok=True)
        exists = [p.name.split('.')[0] for p in dir_path.iterdir()] + ['北京', '上海', '天津', '重庆']
        for province, province_id in self._province_to_region_id.items():
            if province in exists:
                continue
            time_print("开始爬取“%s”的企业数据" % province)
            df_results = self._opt_crawl(Params(province=province))
            df_results = self._clean(df_results=df_results)
            df_results.to_excel(str((dir_path / f"{province}.xlsx").absolute()), index=False)
    ...
    def to_db(self, dir_path: Path) -> None:
        for file_or_dir in dir_path.iterdir():
            if file_or_dir.is_dir():
                self.to_db(file_or_dir)
            else:
                time_print(f"开始{dir_path.name}入库")
                df = pd.read_excel(str(file_or_dir)).fillna('').rename(columns={
                    'RY_ID': 'query_id',
                    '查询ID': 'query_id',
                    '统一社会信用代码': 'unique_social_credit_code',
                    '企业名称': 'enterprise_name',
                    '企业法定代表人': 'enterprise_person',
                    '区域代码': 'region_code',
                    '企业注册属地': 'enterprise_register_location',
                    '原始代码': 'original_code',
                    '注册时间': 'register_time',
                    '数据类型': 'data_type',
                    '资质类别': 'qualify_type'
                })
                df.to_sql('t_company', index=False, con=engine, if_exists='append')
                time_print(f"{dir_path.name}入库成功")
...
if __name__ == '__main__':
    company = Campany()
    company.run_province()
    # company.to_db(company._ROOT_PATH)

    # project = Person()
    # project.concurrent_run(1)

    # print(project.decrypt(""))
